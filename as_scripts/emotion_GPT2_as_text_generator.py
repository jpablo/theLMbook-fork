...
def calculate_accuracy(model: GPT2LMHeadModel, tokenizer: GPT2TokenizerFast, loader: DataLoader[TrainingExample], tag: str = ""):
    """
    ...
    Returns:
        ...
        :param tag:
    """
    print(f"Calculating accuracy for {tag} dataset...")
...
def train():
    ...
    with mlflow.start_run():
        ...
        for epoch in range(num_epochs):
            ...
            test_acc = calculate_accuracy(model, tokenizer, test_loader, f"Epoc {epoch + 1}")
...
def load_model(model_path: str) -> GPT2LMHeadModel:
    device = torch.device("mps" if torch.mps.is_available() else "cpu")
